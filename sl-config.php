...
$args = array(
    ...
    'display_name'         => __( 'Stylish Links Pro', 'sl' ),
    ...
    'menu_title'           => __( 'Stylish Links Pro', 'sl' ),
    'page_title'           => __( 'Stylish Links Pro', 'sl' ),
...
$args['footer_text'] = __( '<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'sl' );
*/
